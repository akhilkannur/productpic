...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-borderSubtle bg-background">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 h-24 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 cursor-pointer group">
          ...
          <span className="font-bold text-xl tracking-tighter text-textMain uppercase">
        ...
        <div className="flex items-center gap-8">
          {isSignedIn ? (
            <button 
              ...
              className="text-[11px] font-bold uppercase tracking-[0.2em] text-textMuted hover:text-textMain transition-colors hidden sm:block"
            >
              Sign Out
            </button>
          ) : (
